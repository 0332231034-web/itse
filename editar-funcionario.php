...
<br><br>
<div class="form-wrapper wrapper-45">
    <center>
        <form action="i-editarfuncionario.php" method="post">
            ...
            <a href="funcionario.php" class="btn-eliminar btn-cancelar">Cancelar</a>
        </form>
    </center>
</div>
</body>
